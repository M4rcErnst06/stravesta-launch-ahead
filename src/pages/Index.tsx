...
const IndexContent = () => {
  ...
  return <div className="min-h-screen relative bg-stravesta-dark">
      ...
      <div className="relative z-20 pt-20">
        ...
        <section id="home" className="pt-20 bg-stravesta-dark relative min-h-screen">
          ...
          <div className="absolute top-24 bottom-12 left-0 right-0 z-5 overflow-hidden">
  ...
  <a
    ...
    className="w-36 flex justify-center items-center space-x-2 bg-gradient-to-r from-blue-500/30 to-purple-500/30 border border-blue-400/50 rounded-xl px-6 py-3"
    target="_blank"
    rel="noopener noreferrer"
  >
